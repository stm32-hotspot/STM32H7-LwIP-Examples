...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
/* ETH_CODE: you can remove this warning when taken into account */
#warning "STM32H747-Disco board hardware needs to be reconfigured to work propely with Ethernet \
	(solder bridge SB21 removed, SB8 fitted)"
/* USER CODE END 0 */
